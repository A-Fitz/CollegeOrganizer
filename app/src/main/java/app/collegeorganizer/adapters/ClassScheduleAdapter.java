...
public class ClassScheduleAdapter extends BaseAdapter {
    private static List<ClassItem> searchArrayList;

    private SimpleDateFormat format_time = new SimpleDateFormat("hh:mm a");

    private LayoutInflater mInflater;

    public ClassScheduleAdapter(Context context, List<ClassItem> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.class_schedule_list_item, null);
