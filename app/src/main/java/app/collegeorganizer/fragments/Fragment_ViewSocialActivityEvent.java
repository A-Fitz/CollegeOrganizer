...
public class Fragment_ViewSocialActivityEvent extends DialogFragment {
    private SocialActivity event;
    ...
    public static Fragment_ViewSocialActivityEvent newInstance() {
        return new Fragment_ViewSocialActivityEvent();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_view_social_activity_event, container, false);
    ...
    public void setEvent(SocialActivity event) {
        this.event = event;
    }
}
