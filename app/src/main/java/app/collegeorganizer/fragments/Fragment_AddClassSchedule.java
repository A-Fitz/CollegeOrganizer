...
@SuppressLint("NewApi")
public class Fragment_AddClassSchedule extends DialogFragment {
    ...
    public static Fragment_AddClassSchedule newInstance() {
        return new Fragment_AddClassSchedule();
    }
        ...
        save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkInput()) {
                    ...
                    Activity_Main.classScheduleList.add(c);
