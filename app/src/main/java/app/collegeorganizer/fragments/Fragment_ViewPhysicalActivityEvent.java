...
public class Fragment_ViewPhysicalActivityEvent extends DialogFragment {
    private PhysicalActivity event;
    ...
    public static Fragment_ViewPhysicalActivityEvent newInstance() {
        return new Fragment_ViewPhysicalActivityEvent();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_view_physical_activity_event, container, false);

        name = v.findViewById(R.id.textview_name);
        details = v.findViewById(R.id.textview_details);
        intensity = v.findViewById(R.id.textview_intensity);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        intensity.setText(event.getIntensity().toString().substring(0, 1).toUpperCase() + event.getIntensity().toString().substring(1).toLowerCase());
    ...
    public void setEvent(PhysicalActivity event) {
        this.event = event;
    }
}
