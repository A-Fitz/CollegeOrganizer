...
public class Fragment_ViewClassEvent extends DialogFragment {
    private ClassItem event;
    ...
    public static Fragment_ViewClassEvent newInstance() {
        return new Fragment_ViewClassEvent();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_view_class_event, container, false);
        ...
        professor = v.findViewById(R.id.textview_professor);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        professor.setText(event.getProfessor());
    ...
    public void setEvent(ClassItem event) {
        this.event = event;
    }
}
