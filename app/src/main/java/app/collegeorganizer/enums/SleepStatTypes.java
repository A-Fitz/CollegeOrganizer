...
public enum SleepStatTypes {
    TOTAL_HOURS_SLEEPING("Total hours sleeping"),
    TOTAL_HOURS_SLEEPING_LAST_MONTH("Total hours sleeping in the last month"),
    TOTAL_HOURS_SLEEPING_LAST_WEEK("Total hours sleeping in the last week"),
    TOTAL_HOURS_SLEEPING_SUNDAYS("Total hours sleeping on Sundays"),
    TOTAL_HOURS_SLEEPING_MONDAYS("Total hours sleeping on Mondays"),
    TOTAL_HOURS_SLEEPING_TUESDAYS("Total hours sleeping on Tuesdays"),
    TOTAL_HOURS_SLEEPING_WEDNESDAYS("Total hours sleeping on Wednesdays"),
    TOTAL_HOURS_SLEEPING_THURSDAYS("Total hours sleeping on Thursdays"),
    TOTAL_HOURS_SLEEPING_FRIDAYS("Total hours sleeping on Fridays"),
    TOTAL_HOURS_SLEEPING_SATURDAYS("Total hours sleeping on Saturdays"),
