...
public enum PhysicalActivityStatTypes {
    TOTAL_HOURS_PHYSICAL("Total hours of physical activity"),
    TOTAL_HOURS_PHYSICAL_LAST_MONTH("Total hours of physical activity in the last month"),
    TOTAL_HOURS_PHYSICAL_LAST_WEEK("Total hours of physical activity in the last week"),
    TOTAL_HOURS_PHYSICAL_SUNDAYS("Total hours of physical activity on Sundays"),
    TOTAL_HOURS_PHYSICAL_MONDAYS("Total hours of physical activity on Mondays"),
    TOTAL_HOURS_PHYSICAL_TUESDAYS("Total hours of physical activity on Tuesdays"),
    TOTAL_HOURS_PHYSICAL_WEDNESDAYS("Total hours of physical activity on Wednesdays"),
    TOTAL_HOURS_PHYSICAL_THURSDAYS("Total hours of physical activity on Thursdays"),
    TOTAL_HOURS_PHYSICAL_FRIDAYS("Total hours of physical activity on Fridays"),
    TOTAL_HOURS_PHYSICAL_SATURDAYS("Total hours of physical activity on Saturdays"),
