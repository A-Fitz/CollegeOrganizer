...
public enum SocialActivityStatTypes {
    TOTAL_HOURS_SOCIAL("Total hours of social activity"),
    TOTAL_HOURS_SOCIAL_LAST_MONTH("Total hours of social activity in the last month"),
    TOTAL_HOURS_SOCIAL_LAST_WEEK("Total hours of social activity in the last week"),
    TOTAL_HOURS_SOCIAL_SUNDAYS("Total hours of social activity on Sundays"),
    TOTAL_HOURS_SOCIAL_MONDAYS("Total hours of social activity on Mondays"),
    TOTAL_HOURS_SOCIAL_TUESDAYS("Total hours of social activity on Tuesdays"),
    TOTAL_HOURS_SOCIAL_WEDNESDAYS("Total hours of social activity on Wednesdays"),
    TOTAL_HOURS_SOCIAL_THURSDAYS("Total hours of social activity on Thursdays"),
    TOTAL_HOURS_SOCIAL_FRIDAYS("Total hours of social activity on Fridays"),
    TOTAL_HOURS_SOCIAL_SATUDAYS("Total hours of social activity on Saturdays"),
