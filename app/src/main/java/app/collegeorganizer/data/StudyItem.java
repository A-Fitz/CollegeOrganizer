...
public class StudyItem {
    ...
    public StudyItem(String name, Calendar startTime, Calendar endTime, int color, String details, String location, List<String> repeating, Calendar repeatUntilDate) {
        this.name = name;
    ...
    public StudyItem(String name, Calendar startTime, Calendar endTime, int color, String details, String location) {
        this.name = name;
        this.startTime = startTime;
        this.endTime = endTime;
        this.color = color;
    ...
    public StudyItem(StudyItem copy) {
    ...
    public boolean equals(Object o) {
        ...
        return color == studyItem.color &&
                scheduleId == studyItem.scheduleId &&
                Objects.equals(name, studyItem.name) &&
                Objects.equals(startTime, studyItem.startTime) &&
                Objects.equals(endTime, studyItem.endTime) &&
                Objects.equals(details, studyItem.details) &&
                Objects.equals(location, studyItem.location) &&
                Objects.equals(repeating, studyItem.repeating) &&
                Objects.equals(repeatUntilDate, studyItem.repeatUntilDate);
    }
